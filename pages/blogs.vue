        ...
        <div class="mx-auto max-w-7xl">
            <div class="relative">
                <div class="mx-auto max-w-2xl lg:max-w-5xl">
                    ...
                    <p class="mb-6 mt-3 text-base text-zinc-600 dark:text-zinc-400">
                        The random ramblings of a man who will do anything but the easy way.
                    </p>
                    <blog-list/>
                    <!-- <div
                        class="mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-12 sm:gap-y-16 lg:grid-cols-2 mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
                        <article
                            ...
                            <div
                                ...
                                <div
                                    class="flex lg:border-t lg:border-gray-900/10 lg:pt-8">
                                    <a
                                        :href="featuredPost.author.href"
                                        class="flex gap-x-2.5 text-sm font-semibold leading-6">
                                        <img
                            ...
                            <div class="-my-12 divide-y divide-gray-900/10">
                                <article
                                    ...
                                    <div class="group relative max-w-xl">
                                        ...
                                        >
                                        <h2
                                            class="mt-2 text-lg font-semibold group-hover:">
                                            <a :href="post.href">
                                                <span
                                    ...
                                    <div class="mt-4 flex">
                                        <a
                                            ...
                                            class="relative flex gap-x-2.5 text-sm font-semibold leading-6">
                                            <img
